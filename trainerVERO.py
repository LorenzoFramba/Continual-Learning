...
class Trainer:
    ...
    def build_model(self):                  
        ...
        self.optim = optim.Adam(self.model.parameters(),                        #usiamo adam per ottimizzazione stocastica come OPTIM, passangogli i parametri
                                ...
                                betas=[self.cfg.beta1, self.cfg.beta2])     #le due Beta, cioe' la probabilita' di accettare l'ipotesi quando e' falsa
    ...
    def train_val(self):
        ...
        for n_iter in range(self.cfg.n_iters):      #da 0 al numero detto di n_iters
            ...
            self.optim.step()   #ottimizza tramite ADAM. DOBBIAMO CAPIRE STO ADAM
            print('Done')#
    ...
    def validate(self, epoch):      
        ...
        _output = output.clone()                                    #copiamo l'output
