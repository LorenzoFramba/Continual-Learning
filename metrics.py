...
#  pixel accuracy * 1 / ( sommatoria ( falsi negativi - pixel correttamente classificati))  * 1 / numero di classi   ``#       
...
def check_size(prediction, groud_truth):
    h_pred, w_pred = segmento_size(prediction)                                                                  #dimensione della matrice prediction
    h_gt, w_gt = segmento_size(groud_truth)                                                                     #dimensione della matrice groud_truth
